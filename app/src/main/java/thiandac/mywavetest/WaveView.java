...
public class WaveView extends View {
     ...
     * +------------------------+__|____
     */
    private static final float DEFAULT_AMPLITUDE_RATIO = 0.025f;//震幅
    private static final float DEFAULT_WATER_LEVEL_RATIO = 0.5f;//水位，可當基本水位高(?
    private static final float DEFAULT_WAVE_LENGTH_RATIO = 1.0f;//波長
    private static final float DEFAULT_WAVE_SHIFT_RATIO = 0.0f;//波移(??)
