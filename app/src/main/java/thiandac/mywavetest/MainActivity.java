...
public class MainActivity extends AppCompatActivity implements Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waveView1.setWaveColor(Color.parseColor("#28f16d7a"), Color.parseColor("#3cf16d7a"));
        textView.setText(String.valueOf(waveView1.getWaterLevelRatio()));
        ...
        waveView2.setWaveColor(Color.parseColor("#40b7d28d"), Color.parseColor("#80b7d28d"));
    ...
    public void updateClient(float data) {
